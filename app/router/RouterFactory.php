...
class RouterFactory
{
	...
	public function createHttpRouter()
	{
		...
		$router[] = new Route('2017/prednasky/zebricek', 'Conference:talksRanking');
		$router[] = new Route('2017/prednasky', 'Conference:talks');
		$router[] = new Route('2017/prednasky/<talkId>', 'Conference:talksDetail');
		...
		$router[] = new Route('2017/program', 'Program:list');
