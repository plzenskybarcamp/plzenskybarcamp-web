...
class RouterFactory
{
	...
	public function createHttpRouter()
	{
		...
		$router[] = new Route('2018', 'Homepage:default');
		...
		$router[] = new Route('2018/informace', 'Homepage:info');
		$router[] = new Route('napsali-o-nas', 'Homepage:written', Route::ONE_WAY);
		$router[] = new Route('2018/napsali-o-nas', 'Homepage:written');
		...
		$router[] = new Route('2018/plzenakovo-slovnicek-pojmu', 'Homepage:vocabulary');
		$router[] = new Route('plzenakovo-slovnicek-pojmu', 'Homepage:vocabulary', Route::ONE_WAY);
		$router[] = new Route('2018/privacy-policy', 'Homepage:privacyPolicy');
		$router[] = new Route('privacy-policy', 'Homepage:privacyPolicy', Route::ONE_WAY);
		$router[] = new Route('2018/terms', 'Homepage:terms');
		$router[] = new Route('terms', 'Homepage:terms', Route::ONE_WAY);
